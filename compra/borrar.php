...
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">¿Esta seguro de eliminar la compra?</h1>
                </div><!-- /.col -->
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <button id="btn_eliminar" class="btn btn-danger btn-block">Eliminar</button>
                                        </div>
                                        <!--script para elminar-->
                                        ...
                                        <script>
                                            $('#btn_eliminar').click(function() {
                                                var IdCompra = '<?php echo $IdCompraGet; ?>';
                                                ...
                                                function eliminar() {
                                                    var url = "../app/controllers/compra/borrar.php";
                                                    $.get(url, {
                                                        IdCompra: IdCompra,
